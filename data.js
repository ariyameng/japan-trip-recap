...
window.TRIP_DATA = {
  ...
  // 封面开场白（一句钩子即可，细节全部留给「日记 · 序章」）
  openingLine: "火车刚开出郑州站，手机就响了。",
  ...
  // ---------- 出发前后 ----------
  //  「行程」只留客观事实（一行灰字）；完整的故事在「日记 · 序章」，不在这里重复
  typhoon: {
    brief: "受台风「白海豚」影响，原定 8 月 9 日飞大阪的航班取消，几经改道，最终于 8 月 10 日从杭州出发抵达关西。"
  },
  ...
  days: [
    {
      ...
      expanded: true,
      projects: [
        "火车上收到第二天航班取消的消息，又急又懵",
        "一路刷各种替代方案，给国航打电话却怎么也打不通",
        "那一晚没敢彻底睡，只是睡得不太踏实"
      ],
      places: ["郑州站", "开往上海的列车"],
      feeling: "又急又懵，变数一个接一个，只能一路熬着。"
    },
    {
      phase: "prologue",
      dateLabel: "8月9日（夜）",
      ...
      projects: [
        "一早去机场排队改签，找航空公司要个说法",
        "晚上航班又取消，再次打电话沟通",
        "好不容易打通不敢挂，电话就那么挂着近 4 个小时",
        "好在国航客服给力，敲定第二天从萧山起飞的方案"
      ],
      places: ["维也纳酒店"],
  ...
  foods: [
    ...
    { name: "松门", city: "京都", note: "三千院前的午餐，没有预约等了一会儿。地址：23 Ohara Shorinincho, Sakyo-Ku" },

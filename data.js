...
window.TRIP_DATA = {
  ...
  days: [
    ...
    },
    {
      ...
      mood: "浅草与电器街",
      moodEmoji: "⛩️",
      story: "今天浅草寺加秋叶原。早上便利店解决，先去浅草寺逛了逛。中午在 CoCo壱番屋（东武浅草駅前店）吃了咖喱饭，下午转战秋叶原，晚上又是便利店，不过便利店门口的夜景还挺好看。",
      spots: ["浅草寺", "秋叶原"],
      photos: [
        "photos/day8-1.jpeg",
        "photos/day8-2.jpeg",
    ...
    },
    {
      ...
      mood: "东京三连",
      moodEmoji: "🗼",
      story: "银座、涩谷、东京塔一站打卡。午餐在银座的みのる食堂（三越銀座店）解决，吃完去了涩谷（到底是涩谷还是涉谷，到现在也没较真清楚），看了忠犬八公像，逛了些店，然后奔东京塔。在塔下看了会儿夜景就往回走，晚餐罗森便利店。",
    ...
    },
    {
      ...
      mood: "镰仓与江之岛",
      moodEmoji: "🌊",
      story: "今天出了趟远门去镰仓。到了镰仓先去 KAMOKOTO KITCHEN 吃午饭，这家店很对胃口。吃完接着上江之岛，海风一吹整个人都松了。回到东京已累瘫，晚上又钻进一兰拉面（浅草店）续命。",
    ...
    },
    {
      ...
      mood: "躺平自由日",
      moodEmoji: "🐱",
      story: "没什么计划的一天，中午才起，去鰻御食事処 九寅（浅草本店）吃了鳗鱼饭。下午去浅草的堂吉诃德，路上遇到一群猫猫，觉得这座城市好多猫。晚餐鸟贵族（浅草六区店），便宜又热闹。",
